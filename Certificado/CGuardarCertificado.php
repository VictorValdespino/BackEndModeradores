...
/*
SmartSoft
Componente: CGuardarCertificado.
...
Descripcion:
Guarda la plantilla de certificados dentro del servidor.
...
if (move_uploaded_file($vManual['tmp_name'],"./Plantilla.docx")) {
    //$docx->transformDocument("./Tmp/P".$vTiempo.".docx", "P".$vTiempo.".pdf");
    print_r(json_encode(array("status"=>200,"info"=>'Se guardo correctamente la plantilla del certificado.',"nombre"=>"/Plantilla.docx")));
}else{
